...
try {
    ...
    $mail->addAddress($userEmail); // Add the recipient's email
        ...
        $mail->Body    = "Dear User,  Greetings! This is to inform you that REOC has recently reviewed your responses to the conditions placed
         upon the ethical approval for the project outlined below. Your research study protocol is now deemed to meet the requirements of the 
         updated health-related ethical guidelines and approval for the issuance of Research Ethics Clearance has been granted.
...
<td>
    ...
    ?>
                    ...
                    <td><a href="admin_review_form.php?id=<?php echo $row['id']; ?>"><button class="review-btn">Review</button></a></td>
                    <td><a href="admin_reviewDocuments.php?researcher_info_id=<?php echo $row['id']; ?>" class="complete-btn-link"><button class="complete-btn">Complete</button></a></td>
