...
$bg_file = 'Research Ethic clearance Cover Letter.pdf';
...
// Calculate the current date + 1 year
$nextYearDate = date('F j, Y', strtotime('+1 year')); // Example: "November 26, 2025"
...
$conn->commit(); // Commit the transaction
    // Save the new PDF
    $outputPath = $_SERVER['DOCUMENT_ROOT'] . '/pdfs/Cover Letter_' . $researcher_title_id .  $finalCode . '_' . date('Y-m-d') . '.pdf';
