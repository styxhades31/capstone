...
.vmcontainer {
    ...
    padding: 50px;
    margin: 0 30% 0 30%;
    background: rgb(133, 47, 47, 10); /* Fallback */
    background: linear-gradient(0deg, rgba(133, 47, 47, 0.9) 0%, rgba(243, 180, 180, 0.9) 100%);
    font-size: 20px;
    border-radius: 10px;
}
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            <div class="file-item">
              ...
              <a href="uploads/REVIEW FORM.pdf" download>Download</a>
            </div>
            <div class="file-item">
...
<section class="divider"></section>
 ...
 <div class="section1">
            ...
            <div class="vs">
    <h1 class="dept_title">REOC Vision</h1>
...
<br>
                ...
                <div class="vs">
    <h1 class="dept_title">REOC Mission</h1>
   <div class="vmcontainer">
                      <br>
...
<br>
                <div class="vs">
    <h1 class="dept_title">REOC Goals</h1>
   <div class="vmcontainer">
                      <br>
