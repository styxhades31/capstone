...
<head>
    ...
    <title>Admin-Researcher - REOC PORTAL</title>
        ...
        <div class="dropdown1">
          ...
          <div class="dropdown-content1">
            <div class="file-item1">
              <a href="admin-researcherSubmitFile.php">Submit Application</a>
            </div>
            <div class="file-item1">
              <a href="admin-researcherViewApps.php">View Applications</a>
            </div>
          </div>
        </div>
...
<section class="home">
      <div class="gradient"></div>
        ...
        <div class="content active">
          ...
          <a href="admin-researcherSubmitFile.php" style="    transition: 0.3s ease;">Submit Application</a>
        </div>
        <div class="content">
