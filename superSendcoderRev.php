        ...
        if (isset($_POST['email'])) {
            ...
            if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
               ...
               if ($emailExists > 0) {
                 ...
                 // Validate names and middle initial
                ...
                if (empty($firstName) || empty($lastName)) {
                    $error = 'Please fill in both first name and last name fields.';
                } elseif (strlen($middleInitial) > 2) {
                    $error = 'Middle initial can be 1 or 2 characters.';
                } else {
                    // Validate passwords
...
if ($stmt->execute()) {
                             ...
                             $_SESSION['middle_initial'] = $middleInitial; // Optional
                            ...
                            if ($verificationCodeSent) {
                                ...
                                header("Location: reviewerAccountcreation.php?role=" . urlencode($role));
                                exit;
                            }
                        } else {
...
<div class="limiter">
    ...
    <div class="wrap-input100 validate-input m-b-26" data-validate="Email is required">
        ...
        <input type="email"  class="input100" id="email" name="email" required placeholder="Enter your email">
    ...
    <div class="wrap-input100SN validate-input m-b-18" data-validate="Required">
        ...
        <input class="input100" type="text" id="first_name" name="first_name" required placeholder="First Name">
        <span class="focus-input100"></span>
   </div>
   ...
   <div class="wrap-input100FN validate-input m-b-18" data-validate="Required">
        <input class="input100" type="text" id="last_name" name="last_name" required placeholder="Last Name">
        <span class="focus-input100"></span>
  </div>

  
  <div class="wrap-input100MI validate-input m-b-18" data-validate="Req">
        <input class="input100" type="text" id="middle_initial" name="middle_initial" maxlength="2" placeholder="M.I.">
        <span class="focus-input100"></span>
  </div>
